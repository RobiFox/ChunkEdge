    ...
    let root_advancement = commands
        .spawn((
            ...
            AdvancementDisplay {
                ...
                icon: ItemStack::new(ItemKind::Stone, 1),
                frame_type: AdvancementFrameType::Task,
                show_toast: true,
                hidden: false,
                background_texture: Some(ident!("block/stone").into()),
                x_coord: 0.0,
                y_coord: 0.0,
            },
            RootAdvancement,
    ...
    commands
        .spawn((
            ...
            AdvancementDisplay {
                ...
                icon: ItemStack::new(ItemKind::OakWood, 1),
                frame_type: AdvancementFrameType::Task,
                show_toast: false,
                hidden: false,
    ...
    commands
        .spawn((
            ...
            AdvancementDisplay {
                ...
                icon: ItemStack::new(ItemKind::AcaciaWood, 1),
                frame_type: AdvancementFrameType::Task,
                show_toast: false,
                hidden: false,
                background_texture: None,
    ...
    commands
        .spawn((
            ...
            AdvancementDisplay {
                ...
                icon: ItemStack::new(ItemKind::IronSword, 1),
                frame_type: AdvancementFrameType::Challenge,
                show_toast: false,
                hidden: false,
                background_texture: Some(Ident::new("block/andesite").unwrap()),
                x_coord: 0.0,
                y_coord: 0.0,
            },
        ))
